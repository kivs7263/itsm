...
| ID | 작업 | 크기 | 상태 |
|---|---|---|---|
| `ESC-0a` | ADR-041 — 에스컬레이션 데이터 모델 결정 | S | `[ DONE 2026-06-16 ]` |
| `ESC-0b` | ADR-042 — 외부 알림 채널 추상화 결정 | S | `[ DONE 2026-06-16 ]` |
...
| ID | 작업 | 크기 | 상태 |
|---|---|---|---|
| `ESC-4a` | 매직링크 JWT 발급 + 검증 미들웨어 | S | `[ DONE 2026-06-16 ]` |
| `ESC-4b` | 포털 전용 API — 티켓 상태 조회 + 타임라인 + 코멘트 작성 | M | `[ DONE 2026-06-16 ]` |
...
| ID | 작업 | 크기 | 상태 |
|---|---|---|---|
| `ESC-5a` | 티켓 상세 우측 패널 — 에스컬레이션 배지 + "2차 이관" 버튼 | S | `[ DONE 2026-06-16 ]` |
| `ESC-5b` | 에스컬레이션 모달 — 팀 선택, 사유, 인수인계 메모, 고객 알림 미리보기 | M | `[ DONE 2026-06-16 ]` |
| `ESC-5c` | 활동 타임라인에 에스컬레이션 이벤트 카드 추가 | S | `[ DONE 2026-06-16 ]` |
| `ESC-5d` | 인지(acknowledge) 버튼 — 2차 담당자용 | S | `[ DONE 2026-06-16 ]` |
...
| `ESC-6b` | 포털 레이아웃 — Alveo 브랜딩, 상태 타임라인, 코멘트 입력 | M | `[ DONE 2026-06-16 ]` |

**포털 화면 구성**

```
[Alveo 로고] [티켓 번호: TKT-DBL-003]
──────────────────────────────────────────
상태: 🔄 처리 중 (2차 전문팀 대응 중)
담당팀: 데이터베이스 엔지니어링팀
